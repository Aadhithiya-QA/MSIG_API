...
public class UpdateCancelQuoteSpec {

    public static RequestSpecification specUpdateCancelQuote(Map<String,String> map, String TermGroupId){
        ...
        requestSpecification
                ...
                .header("EventName", "UpdateCancelQuoteByAccount_3.1.0.0")
                ...
                .body(UpdateCancelQuote.updateCancelQuote(map,TermGroupId));
