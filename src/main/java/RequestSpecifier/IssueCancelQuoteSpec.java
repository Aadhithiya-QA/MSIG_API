...
public class IssueCancelQuoteSpec {

    public static RequestSpecification specIssueCancelQuote(String TermGroupId){
        ...
        requestSpecification
                ...
                .header("EventName", "IssueCancelAccountWrapper_3.0.0")
                ...
                .body(IssueCancelQuote.issueCancelQuote(TermGroupId));
