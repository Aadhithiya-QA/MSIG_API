...
public class IssueReinstateQuoteSpec {

    public static RequestSpecification specIssueReinstateQuote(String TermGroupID){
        ...
        requestSpecification
                ...
                .header("EventName", "IssueReinstateAccountWrapper_1.1.0.4")
                ...
                .body(IssueReinstateQuote.issueReinstateQuote(TermGroupID));
