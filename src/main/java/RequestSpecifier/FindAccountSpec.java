...
public class FindAccountSpec {

    public static RequestSpecification SpecFindAccount(String AccountID){
        ...
        requestSpecification
                ...
                .header("EventName", "FindAccount_1.0.0")
                ...
                .body(FindAccount.findAccountRequest(AccountID));
