...
public class CreateReinstateQuoteSpec {

    public static RequestSpecification specCreateReinstateQuote(String AccountID){
        ...
        requestSpecification
                ...
                .header("EventName", "CreateReinstateQuoteByAccount_3.1.0.0")
                ...
                .body(CreateReinstateQuote.createReinstateQuote(AccountID));
