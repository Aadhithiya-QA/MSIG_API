...
public class GetSubjectivitySpec {

    public static RequestSpecification getSubjectivitySpec(String QuoteID){
        ...
        requestSpecification
                ...
                .header("EventName", "GetSubjectivity_3.1.0.0")
                ...
                .body(GetSubjectivity.getSubjectivityRequest(QuoteID));
        return requestSpecification;

    }

    public static RequestSpecification getSpecificSubjectivitySpec(String QuoteID, String ID1){
        ...
        requestSpecification
                ...
                .header("Mode", PropertyUtils.getValue("Mode"))
                .header("Environment", PropertyUtils.getValue("Env"))
                .body(GetSubjectivity.getSpecificSubjectivityRequest(QuoteID,ID1));
        return requestSpecification;
    }
