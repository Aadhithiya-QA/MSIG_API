...
public class FindQuoteSpec {

    public static RequestSpecification SpecFindQuote(String QuoteID){
        ...
        requestSpecification
                ...
                .header("EventName", "FindQuote_2.0.0")
                ...
                .body(FindQuote.findQuote(QuoteID));
