...
public class BindRequestSpec {

    public static RequestSpecification SpecBindRequest(String QuoteID){
        String url = "";
        ...
        requestSpecification
                ...
                .header("EventName", "BindRequest_2.0.0")
                ...
                .body(BindRequest.bindRequest(QuoteID));
