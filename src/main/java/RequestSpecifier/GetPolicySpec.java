...
public class GetPolicySpec {

    public static RequestSpecification getPolicySpec(String PolicyID){
        ...
        requestSpecification
                ...
                .header("EventName", "GetPolicy_1.0.0")
                ...
                .body(GetPolicy.getPolicyRequest(PolicyID));
