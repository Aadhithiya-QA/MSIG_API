...
public class CreateQuoteSpec {
    ...
    public static RequestSpecification SpecCreateQuote(String QuoteID, String carrierBlock){
        ...
        requestSpecification
                ...
                .header("EventName", "CreateQuoteWF_9.0.0")
                ...
                .body(CreateQuote.createQuote(QuoteID,carrierBlock));
