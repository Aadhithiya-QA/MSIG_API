...
public class PreviewDocumentSpec {


    public static RequestSpecification previewDocumentSpec(String QuoteID){
        ...
        requestSpecification
                ...
                .header("EventName", "PreviewDocument_1.0.0")
                ...
                .body(PreviewDocument.previewDocumentRequest(QuoteID));
