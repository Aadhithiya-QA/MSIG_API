...
public class ReferSubmissionSpec {

    public static RequestSpecification SpecReferSubmission(String SubID){
        ...
        requestSpecification
                ...
                .header("EventName", "ReferSubmissionWF_1.0.2")
                ...
                .body(ReferSubmission.referSubmissionRequest(SubID));
