...
public class ReactivateSubmissionSpec {

    public static RequestSpecification SpecReactivateSubmission(String SubID){
        ...
        requestSpecification
                ...
                .header("EventName", "ReactivateSubmissionWF_1.0.1")
                ...
                .body(ReactivateSubmission.reactivateSubmissionRequest(SubID));
