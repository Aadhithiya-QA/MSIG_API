...
public class LapseOrDeclineQuoteSpec {

    public static RequestSpecification SpecLapseQuote(String QuoteID){
        ...
        requestSpecification
                ...
                .header("EventName", "LapseOrDeclineQuote_WF_1.0.3")
                ...
                .body(LapseOrDeclineQuote.lapseQuote(QuoteID));
        return requestSpecification;

    }

    public static RequestSpecification SpecDeclineQuote(String QuoteID){
        ...
        requestSpecification
                ...
                .header("Mode", PropertyUtils.getValue("Mode"))
                .header("Environment", PropertyUtils.getValue("Env"))
                .body(LapseOrDeclineQuote.declineQuote(QuoteID));
        return requestSpecification;
