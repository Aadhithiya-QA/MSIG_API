...
public class FindSubmissionSpec {

    public static RequestSpecification SpecFindSubmission (String SubNumber){
        ...
        requestSpecification
                ...
                .header("EventName", "FindSubmission_2.0.0")
                ...
                .body(FindSubmission.findSubmissionRequest(SubNumber));
