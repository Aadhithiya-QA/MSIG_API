...
public class GetSubmissionSpec {

    public static RequestSpecification SpecGetSubmission(String SubID){
        ...
        requestSpecification
                ...
                .header("EventName", "GetSubmission_2.0.0")
                ...
                .body(GetSubmission.getSubmissionRequest(SubID));
