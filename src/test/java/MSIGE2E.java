...
//            FileUtils.forceMkdir(new File(FrameWorkPilot.getDynamicPath("resultDir") + "\\" + main.get("Iteration") + "\\PDF\\"));
       ...
       /* LapseOrDeclineQuoteExec lapseOrDeclineQuoteExec = new LapseOrDeclineQuoteExec();
        ...
        String QuoteNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir") + "\\" + main.get("Iteration") + "\\Response\\GetQuote Response.txt", "QuoteNumber").replace("[", "").replace("]", "");
        ...
        // Manuscript
        AddManuscriptExec addManuscriptExec = new AddManuscriptExec();
        addManuscriptExec.exeAddManuscript(main, QuoteID);*/
        // Get Subjectivity
        GetSubjectivityExec getSubjectivityExec = new GetSubjectivityExec();
        getSubjectivityExec.exeGetSubjectivity(QuoteID,main);
        String SubjectivityID = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\GetSubjectivity Response.txt","Subjectivity[0].ID");
        // Diary Notes
        ...
        String ID8 = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\GetSubjectivity Response.txt","Subjectivity[7].ID");
        ...
        saveSubjectivityExec.exeSaveSubjectivity(QuoteID,ID1,ID2,ID3,ID4,ID5,ID6,ID7,ID8,main);
        //Bind Quote
        ...
        String PolicyNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssuePolicy Response.txt","PolicyNumber");
        log.info("PolicyNumber ==== {}",PolicyNumber);
        //Get Policy
        GetPolicyExec getPolicyExec = new GetPolicyExec();
        getPolicyExec.exeGetPolicy(PolicyID,main);
        // Cancel
        CreateCancelQuoteExec createCancelQuoteExec = new CreateCancelQuoteExec();
        createCancelQuoteExec.exeCreateCancelQuote(main,AccountID);
        String CancelQuoteID = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\CreateCancelQuote Response.txt","ID").replace("[", "").replace("]", "");
        String TermGroupId = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\CreateCancelQuote Response.txt","TermGroupId").replace("[", "").replace("]", "");
        log.info("Cancel Quote ID ==== {}",CancelQuoteID);
        log.info("Cancel TermGroup Id ==== {}",TermGroupId);
        //Update Cancel Quote
        UpdateCancelQuoteExec updateCancelQuoteExec = new UpdateCancelQuoteExec();
        updateCancelQuoteExec.exeUpdateCancelQuote(main,TermGroupId);
        //Issue Quote
        IssueCancelQuoteExec issueCancelQuoteExec = new IssueCancelQuoteExec();
        issueCancelQuoteExec.exeIssueCancelQuote(main,TermGroupId);
        // Reinstate
        CreateReinstateQuoteExec createReinstateQuoteExec = new CreateReinstateQuoteExec();
        createReinstateQuoteExec.exeCreateReinstateQuote(main,AccountID);
        String ReinstateQuoteID = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\CreateReinstateQuote Response.txt","QuoteID").replace("[", "").replace("]", "");
        String TermGroupID = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\CreateReinstateQuote Response.txt","TermGroupId").replace("[", "").replace("]", "");
        log.info("Reinstate Quote ID ==== {}",ReinstateQuoteID);
        log.info("Reinstate TermGroup Id ==== {}",TermGroupID);
        //Update Reinstate Quote
        UpdateReinstateQuoteExec updateReinstateQuoteExec = new UpdateReinstateQuoteExec();
        updateReinstateQuoteExec.exeUpdateReinstateQuote(main,TermGroupID);
        //Issue Reinstate
        IssueReinstateQuoteExec issueReinstateQuoteExec = new IssueReinstateQuoteExec();
        issueReinstateQuoteExec.exeIssueReinstateQuote(main,TermGroupID);
        ExcelUpdater(main);
        Thread.sleep(1500);
        compareValues(main);
        Thread.sleep(1500);
    ...
    private void ExcelUpdater(Map<String,String>main){
        ...
        String PolicyNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssuePolicy Response.txt","PolicyNumber").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Policy Number", PolicyNumber,Thread.currentThread().getName());
        String CancelPremium = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssueCancelQuote Response.txt","TotalPremium").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Cancel Premium",CancelPremium,Thread.currentThread().getName());
        String ReinstatePremium = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssueReinstateQuote Response.txt","TotalPremium").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Reinstate Premium",ReinstatePremium,Thread.currentThread().getName());
        String SubmissionNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\GetQuote Response.txt","SubmissionNumber").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Submission Number", SubmissionNumber,Thread.currentThread().getName());
        String QuoteNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\GetQuote Response.txt","QuoteNumber").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Quote Number", QuoteNumber,Thread.currentThread().getName());
        String CancelQuoteNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssueCancelQuote Response.txt","QuoteNumber").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Cancel Quote Number", CancelQuoteNumber,Thread.currentThread().getName());
        String ReinstateQuoteNumber = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\IssueReinstateQuote Response.txt","QuoteNumber").replace("[", "").replace("]", "");
        ExcelWriter.excelWriter("Reinstate Quote Number", ReinstateQuoteNumber,Thread.currentThread().getName());
        String EmployeeBenefitsPremium = ParamGetter.getPropertyUsingPath(FrameWorkPilot.getDynamicPath("resultDir")+"\\"+main.get("Iteration")+"\\Response\\GetQuote Response.txt","Account.Insured[0].GeneralLiability.Policy[0].GeneralLiabilityEmployeeBenefitsLiabCovClaimsMade[0].Premium").replace("[","").replace("]","");
        ExcelWriter.excelWriter("EmployeeBenefitsPremium",EmployeeBenefitsPremium,Thread.currentThread().getName());
